...
(async () => {
  ...
  // 2026-09-26: 머리줄이 「주문 N건 (테이블 A · 포장 B)」 이 됐다 — 주문 1건 = 손님 한 팀.
  check("★ 주문 목록도 3건으로 줄었다", /주문 3건/.test(am.orderCount), am.orderCount);
  ...
  check("주문 목록은 2건", /주문 2건/.test(pm.orderCount), pm.orderCount);
